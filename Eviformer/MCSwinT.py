...
#                      dim=128, depth=2, num_heads=8, window_size=64)
#     return model


class mcswint(nn.Module):
    def __init__(self, in_channel, out_channel):
        super(mcswint, self).__init__()
        self.model = MCSwin_T(in_c=in_channel, h_args=[100, 64, 32], num_cls=out_channel,
                     kernel_sizes=[15, 9, 5, 3],
                     strides=[2, 1, 1, 1],
                     out_channels=[64, 128, 128, 192],  # out_channels=[64, 128, 128, 192],
                     dim=128, depth=3, num_heads=8, window_size=16) # num_heads=8,window_size=16,depth=6,dim=128
